"""
Django settings for qtype_creation_46249 project.
...
ROOT_URLCONF = 'qtype_creation_46249.urls'
...
WSGI_APPLICATION = 'qtype_creation_46249.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qtype_creation_46249 API",
    "DESCRIPTION": "API documentation for qtype_creation_46249 App",
    "VERSION": "v1",
}
